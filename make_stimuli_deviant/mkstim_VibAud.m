...
if par.IS_NOISE
    par.tracks.carrier = rand(size(t));
else
    for i=1:length(par.f0)
...
ndevVib1=[1 2];% number of deviant cycles in the first and second deviant trials in Vibro1 block (2 1)
ndevAud1=[2 3];% number of deviant cycles in the first and second deviant trials in Audio1 block (1 3)
ndevVib2=[3 2];% number of deviant cycles in the first and second deviant trials in Vibro2 block (2 3)
